...
%% CALCULATION OF MATRICES AND PHI
...
for j=1:length(grid)
    ...
    % figure and add description to legend
...
if answer == "yes"
    set(0,'CurrentFigure',f1);
    print('-djpeg','Comparison of numerical and exact solution','-r250');
    set(0,'CurrentFigure',f2);
    print('-djpeg','Error plot','-r250');
end